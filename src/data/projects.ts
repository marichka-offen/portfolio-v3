...
export const projectData: ProjectData[] = [
    {
        ...
        partner: "Framebridge marketing team",
...

    {
        ...
        icon: "beauty",
        tagline: "Custom skin solutions for a fast-scaling beauty studio.",
        aboutClient:
            "Dermaflesh is a boutique skincare brand built around estheticians and small-batch formulations sold online through Shopify.",
        workSummary: [
        ...
        partner: "Dermaflesh founders + contractor team",
    },

    {
        ...
        role: "Front-End Engineer, Shopify",
        partner: "Rare Beauty digital + retail teams",
...

    {
        ...
        partner: "Global e-commerce operations",
...

    {
        ...
        icon: "makeup-brush",
        tagline: "High-powered formulas backed by high-performing code.",
        aboutClient:
            "Haus Labs by Lady Gaga is a clean, sustainable beauty brand sold through Sephora and global pop-ups.",
        workSummary: [
        ...
        role: "Front-End Engineer",
        partner: "Haus Labs marketing + engineering teams",
...

    {
        ...
        role: "Front-End Engineer",
        partner: "Leatherology creative + merchandising",
...

    {
        ...
        partner: "Prefect design + OSS contributors",
        siteUrl: "https://www.prefect.io",
    },

    {
        ...
        icon: "prefect",
        tagline: "A shared design language for data reliability tools.",
        aboutClient:
        ...
        partner: "Prefect brand + product marketing",
        siteUrl: "https://www.prefect.io",
    },

    {
        ...
        role: "Front-End Engineer",
        partner: "Cross-functional data squads",
    },

    {
        ...
        icon: "stationary",
        tagline: "A stationery favorite built for modern promotions.",
        aboutClient:
            "Paper Source is a national retailer with heavy seasonal campaigns and product launches.",
        workSummary: [
        ...
        partner: "Paper Source e-commerce team",
...

    {
        ...
        icon: "nova",
        tagline: "Humanitarian aid updates built for urgency.",
        aboutClient:
            "Nova Ukraine is a nonprofit delivering humanitarian aid and sharing verified updates with global donors.",
        workSummary: [
        ...
        partner: "Nova Ukraine volunteer network",
...

    {
        ...
        icon: "coffee-bag",
        tagline: "Third-wave coffee storytelling with performant UI.",
        aboutClient:
            "Stumptown is a pioneer of third-wave coffee, known for seasonal beans and cold brew subscriptions.",
        workSummary: [
        ...
        role: "Front-End Engineer",
        partner: "Stumptown creative studio",
...

    {
        ...
        icon: "coffee-cup",
        tagline: "A beloved roaster with enterprise reliability.",
        aboutClient:
            "Peet’s Coffee operates cafés and nationwide wholesale, with a digital storefront supporting subscriptions and seasonal offerings.",
        workSummary: [
        ...
        role: "Front-End Engineer",
        partner: "Peet’s Coffee digital product team",

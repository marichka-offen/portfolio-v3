...
export const featuredWork: FeaturedCard[] = [
    {
        ...
        description:
            'Led frontend rebuild of product pages with Vue 3, creating modular architecture that reduced content update time by 80% and streamlined subscription management.',
